...
import { BasketList, CardSame } from "../components";
import { Button, NavArrow } from "../components/CustomComponents";
...
const SideBar = (props: SideBarProps) => {
  const { className, store, refProp } = props;
  return (
    <div ref={refProp} className={`sidebar ${className}`}>
      <div className="sidebar-inner">
        <div className="sidebar-header mb-24">
          <Title20 title="Товар в корзине" className="" />
          <button onClick={() => store.setBasket(false)} className="btn-close">
