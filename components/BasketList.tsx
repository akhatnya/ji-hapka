      ...
      <div className="basket-right">
        ...
        {inRight && (
          <div className="add-btns-inner">
            <Button
              onClick={() => {
                store.deleteAllJihazType(item.id);
              }}
              iconLeft={true}
              sizeIcon="16"
              svgIcon="/images/icons/trash-16.svg#root"
            ...
            <Button
              iconLeft={true}
              sizeIcon="16"
              svgIcon="/images/icons/heart-16.svg#root"
              title="Добавить в избранное"
              className="btn btn-secondary-hb btn-32"
            />
          </div>
        )}
        {inBlock && (
          <div className="add-btns-inner">
            <Button
              ...
              svgIcon="/images/icons/trash-16.svg#root"
              title="Удалить"
              className="btn btn-secondary-hb third-color btn-40"
            />
            <Button
              onClick={() => {
                ReactGA.event({
                ...
                store.addJihaz(item), store.setFav(), store.setBasket();
              }}
              iconLeft={true}
              sizeIcon="24"
              svgIcon="/images/icons/cart-badge-plus-24.svg#root"
              title="Добавить в корзину"
              className="btn btn-secondary-hb btn-40"
            />
          </div>
        )}
      </div>
