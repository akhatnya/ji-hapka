        ...
        <div className="seller-block">
          ...
          <div className="seller-text-btn">
            <div className="sellers-list">
              <div className="sellers-item">
                ...
                <div className="sellers-text">
                  <SubTitle16
                    title="Поток целевых покупателей"
                    className="font-700"
                  />
                  <SubTitle16
                    title="Мы приведем к вам горячих клиентов, ваша задача — закрыть продажу"
                    className=""
                  />
                </div>
              </div>
              ...
              <div className="sellers-item">
                ...
                <div className="sellers-text">
                  <SubTitle16
                    title="Ускорение принятия решения"
                    className="font-700"
                  />
                  <SubTitle16
                    title="Клиенты на 40% чаще покупают товары после примерки их в комнате"
                    className=""
                  />
                </div>
              </div>
              ...
              <div className="sellers-item">
                ...
                <div className="sellers-text">
                  ...
                  <SubTitle16
                    title="Качественные фото, 3D визуализация, рекламная поддержка и много чего ещё"
                    className=""
                  />
                </div>
              </div>
            ...
            <div className="d-flex-align-center">
              <Button
                ...
                title="Подать заявку"
                className="btn btn-primary btn-48 mr-16"
              />
              <Button
                iconRight={true}
                sizeIcon="24"
                ...
                className="btn btn-secondary btn-48"
              />
            </div>
          </div>
          ...
          <div className="sellers-banner">
            <div
              ...
              style={{
                backgroundImage: "url(../images/banners/sellers-1.png)",
              }}
            ></div>
          </div>
        </div>
