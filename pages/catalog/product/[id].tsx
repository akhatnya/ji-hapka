...
import { addBasketItem, setBasketItems } from '../../../redux';
                        ...
                        item ?
                            <div className="col-md-4">
                                <div className="product-inner-info">
                                    ...
                                    <Button onClick={onAddBasketItem} iconLeft={true} sizeIcon="32" svgIcon="/images/icons/cart-badge-plus.svg#root" title={itemInBasket ? "Товар в корзине" : "Добавить в корзину"} className="btn btn-primary w-100 btn-54" />
                                </div>
                            </div> : null
                    }
                </div>
