...
import { Button, Input, RadioButton } from "../components/CustomComponents";
import BckDrp from "../components/CustomComponents/BckDrp";
import { useBasketStore } from "../providers/RootStoreProvider";
import { Title20, Title16, SubTitle16 } from "../components/Typography";
                  ...
                  <div className="side-order-inner">
                    ...
                    {status ? (
                      <div className="order-status">
                        ...
                        />
                        <SubTitle16
                          title="В ближайшее время вам перезвонит менеджер для уточнения деталей"
                      ...
                      >
                        ...
                        <div className="action mt-24">
                          ...
                          <p className="link-agree">
                            ...
                            условия <a href="#!">Договора оферты</a>, а также
