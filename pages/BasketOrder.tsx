                    ...
                    <Title24 title="Оформление заказа" className="mb-32" />
                    {
                        store.basket.length !== 0 ? (
                            ...
                            !status && (
                                ...
                                <Button onClick={goShop} iconRight={true} sizeIcon="24" svgIcon="/images/icons/arrow-right-24.svg#root" title="Перейти к покупкам" className="btn btn-primary btn-54 prl-side-32" />
                            </div>
                            )
                        )
                    }
